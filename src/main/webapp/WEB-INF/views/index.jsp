<html>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="${pageContext.request.contextPath}/img/logo.png" alt="logo" class="logo-1"> </a>
          ...
          <div class="row">
            <div class="col-md-8 col-sm-12">
              <div class="banner-text">
                ...
                <ul>
                  <li><a href="#"><img src="${pageContext.request.contextPath}/img/appstore.png" class="wow fadeInUp" data-wow-delay="0.4s"/></a></li>
                  <li><a href="#"><img src="${pageContext.request.contextPath}/img/playstore.png" class="wow fadeInUp" data-wow-delay="0.7s"/></a></li>
                </ul>
              </div>
            </div>
            <div class="col-md-4 col-sm-12"> <img src="${pageContext.request.contextPath}/img/iphone-screen.png" class="img-fluid wow fadeInUp"/> </div>
          </div>
        </div>
      </div>
      <span class="svg-wave"> <img class="svg-hero" src="${pageContext.request.contextPath}/img/applight-wave.svg"> </span> </section>
            ...
            <div class="section-content text-center">
              <div class="row">
                ...
                <div class="col-md-4 d-none d-md-block d-lg-block">
                  <div class="feature-mobile"> <img src="${pageContext.request.contextPath}/img/iphone-screen-with-shadow.png" class="img-fluid wow fadeInUp"/> </div>
                </div>
                <div class="col-md-4 col-sm-12">
                  <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-content text-center">
              <div class="row">
                <div class="col-md-4">
                  <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="${pageContext.request.contextPath}/img/user1.jpg" class="img-fluid"/>
                    <h4>Nitu Singh</h4>
                    <p>Marketing Specialist</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="team-detail wow bounce" data-wow-delay="0.4s"> <img src="${pageContext.request.contextPath}/img/user2.jpg" class="img-fluid"/>
                    <h4>Yogesh Singh</h4>
                    <p>CEO & Founder</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="team-detail wow bounce" data-wow-delay="0.6s"> <img src="${pageContext.request.contextPath}/img/user3.jpg" class="img-fluid"/>
                    <h4>Nisha Sharma</h4>
                    <p>Web Developer</p>
                  </div>
                </div>
